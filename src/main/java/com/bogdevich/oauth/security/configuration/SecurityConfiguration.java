...
/**
 * Custom control of security configuration.
 * {@link EnableWebSecurity} turns off default configuration.
 * {@link WebSecurityConfigurerAdapter} gives the base to configure the authentication process.
 *
